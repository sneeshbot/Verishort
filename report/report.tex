...
\section{An Introduction to Verishort}
    ...
    and write. First, we have reduced repetitiveness in accordance with the DRY (Donâ€™t 
    ...
    descriptions. We substantially simplified synchronous logic by doing away with â€˜alwaysâ€™ 
    syntax and replacing it with simple â€˜ifâ€™ statements. The list of reserved keywords has been 
...
\section{Reference Manual}
    \subsection{Lexical Conventions}
        ...
        character â€˜xâ€™ as a binary digit. They may only be used in case structures.}
        \end{itemize}
    ...
    These can be done en masse, such as in buses (multi-bit wires) or one by one.
        ...
        Ports are bound to wires when instantiating a module by setting the moduleâ€™s parameter name 
    ...
    most basic building blocks to complex operations.
        ...
        in the â€œoperand operation operandâ€ style with both operands being the same size which is also the 
        ...
        syntax error. The operation is done in twoÕs complement.\\\\
        \texttt{e0 = 0111b; //7d}\\
        \texttt{e1 = 1111b; //7d}\\
    ...
    Verishort code offering specific functionality.\\
        ...
        value.  An expression returning 1 evaluates as the equivalent of ÔtrueÕ and 0 as ÔfalseÕ.  An \texttt{else} 
        ...
        This is especially useful when the user wants to test for conditions on certain bits but doesnÕt care 
        ...
        \texttt{
        wire w[3] = ... \tab // also assume a 3-bit output ÔoutÕ \\
        case(w) \{ \\
