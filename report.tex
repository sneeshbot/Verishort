...
\subsection{Gcd.vs}
\lstinputlisting{gcd.vs}
\subsection{Gcd.v}
\lstinputlisting{gcd.v}
\subsection{Helloworld.vs}
\lstinputlisting{helloworld.vs}
\subsection{Helloworld.v}
\lstinputlisting{helloworld.v}
\end{document}
